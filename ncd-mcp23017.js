...
const MCP23017 = require("./index.js");
...
module.exports = function(RED){
	...
	function NcdI2cDeviceNode(config){
		...
		this.sensor = new MCP23017(this.addr, config, RED.nodes.getNode(config.connection).i2c);
		sensor_pool[this.id] = {
			sensor: this.sensor,
			polling: false,
			timeout: 0,
	...
	RED.nodes.registerType("ncd-mcp23017", NcdI2cDeviceNode)
}
